...
class Clock:
    ...
    def __init__(self, st):
        ...
        self.last_move_quick = process_time()
    ...
    def is_time_to_move_quick(self):
        return (process_time() - self.last_move_quick) > self.st.time_move_quick
